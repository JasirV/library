            ...
            <div className="cs_main_header_in">
              <div className="cs_main_header_left">
                <Link className="cs_site_branding" href="/">
                  <span
                    // className="flex items-center justify-center bg-white text-black font-bold"
                    style={{ color:"white",fontWeight:"bolder", width: "213px", height: "55px", fontSize: "32px" }}
                  >
                    Library
                  </span>
                </Link>
                ...
                <div className="header-btn d-flex align-items-center">
                  <div className="main-button header-btn-1">
                    ...
                    <Link href="/contact" className="theme-btn">
                      <span>
                        {" "}
                        Get Consultation <i className="bi bi-arrow-right"></i>
                      </span>
                    </Link>
                  </div>
                </div>
